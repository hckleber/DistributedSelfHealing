...
//extern int led; // Cria variável led

#define NB_VIZIN 1
#define N_Fila 10 // Vizinhos + margem
extern int xxx;
extern int Fila [N_Fila][8]; // Cria matriz para fila de msg
extern int F_Ini;
extern int F_Fim;
extern int vizinhos[3][NB_VIZIN]; // Cria matiz vizinhos
extern int m_peso;
extern int m_pos;
extern int L;
extern int S;
...
extern int Tp_Msg;
extern int Tp_Msg_R;
extern int Tp_Process;
extern int Dest;
extern int Orig;
extern int Halt;

//extern int Msg_Buffer[1][8];

extern int F_Initiate;
extern int Add_Vizin;


extern int Flag_InitS;
extern int H_Send;

//extern int recebido[4][2];
extern int mutexR;
extern int mutexPC;
#define NB_ROBOTS 2
extern int Address_robo[NB_ROBOTS];
//extern int PROPORCAO[NB_TASKS];
